import { convertToDate } from "../helpers/unitConversions";
            ...
            <table className="min-w-full divide-y divide-gray-300">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {shots.map((shot) => (
                  ...
                  >
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500 min-w-[180px]">
                      {convertToDate(shot.shotTime)}
                    </td>
                    {fields.map(({ id, units }) => (
                      <td
                        key={id}
                      ...
                      >
                        {id === "shotTime" ? convertToDate(shot[id]) : shot[id]}
                        {units === "degrees" && "°"}
                      </td>
                    ))}
                  </tr>
